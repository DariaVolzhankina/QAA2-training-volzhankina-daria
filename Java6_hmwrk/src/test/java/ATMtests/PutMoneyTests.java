...
public class PutMoneyTests {
    ...
    @Test(dataProvider = "putMoneyWrongCurrencyException", expectedExceptions = WrongCurrencyException.class)
    public void testWithdrawMoneyDebitWrongCurrencyException(ATM atm, DebitCard card, Cash cash) {
        atm.putMoney(card,cash);
    }

    @Test(dataProvider = "putMoneyMoneyAmountException", expectedExceptions = MoneyAmountException.class)
